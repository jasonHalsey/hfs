...
if ( have_posts() ) :
	while ( have_posts() ) :
		...
		$outputT = '<section class="background js-coll-page-section coll-page-section balls">';
		...
		?>
		<div class="wrapper common coll-single coll-parallax balls3" id="skrollr-body">
		<?php echo $outputT; ?>
		...
		<section class="js-coll-page-section coll-page-section balls">
			<div class="row">
				<div class="large-12 columns">
