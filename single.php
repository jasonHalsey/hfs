...
if (have_posts()) :
    while (have_posts()) :
        ...
        if (has_post_thumbnail()) {
            ...
            $outputT .= '<section class="background js-coll-page-section coll-page-section Balls2">';
        ...
        ?>
        <div class="wrapper common balls4 coll-single coll-post <?php if (has_post_thumbnail()) echo 'coll-parallax' ?>" id="skrollr-body">
        <?php echo $outputT; ?>
